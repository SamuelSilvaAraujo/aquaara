# Generated by Django 2.1.5 on 2019-06-30 21:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system', models.CharField(choices=[('intensive', 'Intensivo'), ('semi-intensive', 'Semi-Intensivo')], max_length=2, verbose_name='Sistema')),
                ('type_intensive', models.CharField(blank=True, choices=[('constant-renewal', 'Renovação Constante'), ('constant-renewal-aerators', 'Renovação Constante + Aeradores'), ('water-good-quality-high-renewal-aerators', 'Água de boa qualidade + Alta renovação + Aeradores')], max_length=4, null=True, verbose_name='Tipo de sistema intensivo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cyle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Cycle')),
            ],
        ),
        migrations.CreateModel(
            name='Mortality',
